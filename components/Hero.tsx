  ...
  return (
    <div id="hero" className='pb-20 pt-36 flex flex-col lg:flex-row items-center lg:items-start lg:space-x-10 container mx-auto'>
      <div className='lg:w-1/2 text-center lg:text-left pt-32'>
        ...
        className='text-6xl font-bold mb-8'>Hi there! I am Haseeb
        </motion.h1>
        <motion.p
        initial={{opacity: 0, y:50}}
        animate={{opacity: 1, y:0}}
        ...
        <motion.button
          ...
          className="text-xl border-2 w-3/4 sm:w-1/2 border-black p-2 mt-8 rounded-md hover:border-white bg-gray-900 text-white flex items-center justify-center space-x-2 mx-auto lg:mx-0"
        >
          <svg
